...
export function Feedback() {
  ...
  const email = useTakeShapeStore((state) => state.email);
  const setFeedbackClosed = useAiStore((state) => state.setFeedbackClosed);
  const selectedMessageId = useAiStore((state) => state.selectedMessageId);
  const selectedMessage = useAiStore((state) => state.selectedMessage);
  const isPositive = useAiStore((state) => state.isPositive);
