...
export default function AiChat() {
  const { session, sendMessage, mutate, reset, error } = useAi();
  ...
  useEffect(() => {
    ...
    setWelcome(
      "I can find compatible products for your vehicle. Begin by entering your vehicle's year, make, and model."
    );
